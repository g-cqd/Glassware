...
private struct PaddingPreview: View {
    let config: ToolbarPaddingConfiguration
    let title: String
...
private struct PaddingComparisonView: View {
    var body: some View {
        VStack(spacing: 24) {
            ...
            configRow(
                title: "Custom (24pt)",
                config: ToolbarPaddingConfiguration(additionalPadding: 24),
    ...
    private func configRow(
        title: String,
        config: ToolbarPaddingConfiguration,
        description: String
    ) -> some View {
...
private struct CustomPaddingBuilder: View {
    ...
    private var config: ToolbarPaddingConfiguration {
